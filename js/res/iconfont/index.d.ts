...
interface Props extends GProps, ViewProps {
  name: 'push' | 'Search' | 'yigouxuan' | 'weigouxuan' | 'qqqun' | 'lianxifangshi' | 'Computer' | 'xiajiantou' | 'shangjiantou' | 'paixu' | 'youjiantou' | 'fenxiang' | 'zuozhe' | 'guanyu' | 'wentifankui' | 'zidingyizhuti' | 'jiaocheng' | 'gouxuan' | 'yichu' | 'share' | 'back' | 'triangle-down' | 'triangle-up' | 'collection-selected' | 'collection' | 'welcome' | 'github1' | 'tendency' | 'hot' | 'mine' | 'collectionActive' | 'github';
  size?: number;
  color?: string | string[];
}
